...
This is a v0 draft reference generated from mixed-format ID10 source inputs.
...
| `ID10:OH:DCM01:tx` | `OH` | `DCM01` | `tx` | `proposed` | source IOC: sim |
| `ID10:OH:DCM01:y2` | `OH` | `DCM01` | `y2` | `proposed` | source IOC: sim |
| `ID10:OH:DCM01:z2` | `OH` | `DCM01` | `z2` | `proposed` | source IOC: sim |
...
| `ID10:EH:STG01:theta` | `EH` | `STG01` | `theta` | `proposed` | source IOC: sim |
| `ID10:EH:STG01:phi` | `EH` | `STG01` | `phi` | `proposed` | source IOC: sim |
| `ID10:EH:STG01:fine_x` | `EH` | `STG01` | `fine_x` | `proposed` | source IOC: sim |
| `ID10:EH:STG01:fine_y` | `EH` | `STG01` | `fine_y` | `proposed` | source IOC: sim |
| `ID10:EH:STG01:fine_z` | `EH` | `STG01` | `fine_z` | `proposed` | source IOC: sim |
| `ID10:EH:STG01:scan_x` | `EH` | `STG01` | `scan_x` | `proposed` | source IOC: sim |
| `ID10:EH:STG01:scan_y` | `EH` | `STG01` | `scan_y` | `proposed` | source IOC: sim |
| `ID10:EH:DET01:x` | `EH` | `DET01` | `x` | `proposed` | source IOC: sim |
| `ID10:EH:DET01:y` | `EH` | `DET01` | `y` | `proposed` | source IOC: sim |
| `ID10:EH:DET01:z` | `EH` | `DET01` | `z` | `proposed` | source IOC: sim |
| `ID10:OH:WBSLT01:top` | `OH` | `WBSLT01` | `top` | `proposed` | source IOC: sim |
| `ID10:OH:WBSLT01:bot` | `OH` | `WBSLT01` | `bot` | `proposed` | source IOC: sim |
| `ID10:OH:WBSLT01:inb` | `OH` | `WBSLT01` | `inb` | `proposed` | source IOC: sim |
...
| `ID10:PTL:IVU:girder_x` | `PTL` | `IVU` | `girder_x` | `proposed` | source IOC: sim |
| `ID10:PTL:IVU:girder_y` | `PTL` | `IVU` | `girder_y` | `proposed` | source IOC: sim |
| `ID10:PTL:IVU:girder_pitch` | `PTL` | `IVU` | `girder_pitch` | `proposed` | source IOC: sim |
| `ID10:PTL:IVU:girder_yaw` | `PTL` | `IVU` | `girder_yaw` | `proposed` | source IOC: sim |
